...
import MainLayout from "@/Layouts/MainLayout"; // Importamos el MainLayout
import img1 from "@/assets/img1.jpeg";
import img2 from "@/assets/img2.png";

export default function Welcome() {

    // El contenido que irá dentro del MainLayout
    const content = (
        <div>
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        ...
                                        artificial esta revolucionando la forma
                                        en la que desarrollamos y mantenemos un
                                        sitio web. Desde testeo automatico hasta
                                ...
                                <CardContent className="p-4">
                                    <div className="space-y-3">
                                        ...
                                        <h3 className="font-semibold">
                                            Latest Developments in Tech Industry
                                        </h3>
                                        <p className="text-sm text-muted-foreground line-clamp-2">
                                            Stay updated with the most recent
                            ...
                            <Card key={i} className="flex gap-4 p-4">
                                ...
                                <CardContent className="p-0">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-muted-foreground line-clamp-2">
                                            Discover what's trending in the tech
                                            world right now.
                                        </p>
                                    </div>
                                </CardContent>
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-3">
                                    Únete a nosotros para explorar las últimas
    ...
    // Envolvemos el contenido con MainLayout
    return <MainLayout selectedTab="presentando">{content}</MainLayout>;
}
